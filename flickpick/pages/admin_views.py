...
class GenericObjectLookup(TemplateView):
    ...
    def source_actor_options(self, query):
        return Actor.objects.filter(name__icontains=query)

    def source_writer_options(self, query):
    ...
    def get_context_data(self, **kwargs):
        ...
        catalog_limit = None
        cat_index = 0
        for cat_type in [Director, Actor, Writer, Genre]:
